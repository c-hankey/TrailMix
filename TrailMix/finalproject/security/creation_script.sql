...
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('Camden','Hankey','camden',SHA1('camden'),'s_cmhankey1@pennwest.edu');
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('Daniel','Hackenberg','daniel',SHA1('daniel'),'s_djhackenbe@pennwest.edu');
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('Bill','Updater','bill',SHA1('joe'),'bill@localhost');
