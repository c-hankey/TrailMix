    ...
    <div class="d-flex flex-md-row flex-column">
            <table class="table table-bordered m-3 align-self-start">
                ...
                <tbody>
                    <tr>
                        <td>Baker</td>
                        <td>Features the Forest Cathedral, Henry’s Run Sawmill Dam, Seneca Point, and fire tower. Also, through Allegheny National Forest. 140-mile hiking trail traversing six counties.</td>
                        <td>4/5</td>
                        <td>12.0</td>
                        <td>No</td>
                        <td>Yes</td>
